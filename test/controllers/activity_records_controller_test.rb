...
class ActivityRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_record" do
    assert_difference('ActivityRecord.count') do
      post activity_records_url, params: { activity_record: { activity_id: @activity_record.activity_id, date: @activity_record.date, status: @activity_record.status, type: @activity_record.type, user_id: @activity_record.user_id } }
    end
  ...
  test "should update activity_record" do
    patch activity_record_url(@activity_record), params: { activity_record: { activity_id: @activity_record.activity_id, date: @activity_record.date, status: @activity_record.status, type: @activity_record.type, user_id: @activity_record.user_id } }
